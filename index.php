...
<html lang="en">
  ...
  <br><br>
		  ...
		  <div class="card-body">
			...
			<div id="loginMessage"></div>
			  <div class="form-group">
				...
				<input type="text" class="form-control" id="loginUsername" name="loginUsername" value="jefeventas">
			  </div>
			  <div class="form-group">
				<label for="loginPassword">Contraseña</label>
				<input type="password" class="form-control" id="loginPassword" name="loginPassword" value="unach">
			  </div>
    ...
    <footer class="footer bg-dark">
      <div class="container">
        <p class="m-0 text-center text-white" ><b> Juan Luis Gonzalez Villalobos y Elda Berenice Galvez Fierros </b></p>
      </div>
    </footer>
...
<!-- http://localhost/PrimeraEvaluacion/index.php -->